##PATH
Query1 <- paste0(.libPaths()[1], "/OhdsiDataCatalogue/data_catalogue_sql/method_of_data_collection.sql")
Query2 <- paste0(.libPaths()[1], "/OhdsiDataCatalogue/data_catalogue_sql/Data_Start_date.sql")
Query3 <- paste0(.libPaths()[1], "/OhdsiDataCatalogue/data_catalogue_sql/Total_number_of_patients.sql")
Query4 <- paste0(.libPaths()[1], "/OhdsiDataCatalogue/data_catalogue_sql/Total_visits.sql")
Query5 <- paste0(.libPaths()[1], "/OhdsiDataCatalogue/data_catalogue_sql/Total_number_of_providers.sql")
Query6 <- paste0(.libPaths()[1], "/OhdsiDataCatalogue/data_catalogue_sql/Total_number_of_care_sites.sql")
Query7 <- paste0(.libPaths()[1], "/OhdsiDataCatalogue/data_catalogue_sql/Total_number_of_specialties.sql")
